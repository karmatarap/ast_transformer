...
fstride=10
tstride=10
tr_data=./data/datafiles/zambezi_train_data.json
val_data=./data/datafiles/zambezi_valid_data.json
eval_data=./data/datafiles/zambezi_eval_data.json
...
--label-csv ./data/zambezi_class_labels_indices.csv --n_class 2 \
